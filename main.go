...
import (
	...
	"flag"
	"fmt"
	"github.com/doit05/gokittest/logger"
	"net/http"
	"os"
	"os/signal"
	"syscall"
	...
	"github.com/doit05/gokittest/booking"
	"github.com/doit05/gokittest/cargo"
	"github.com/doit05/gokittest/handling"
	"github.com/doit05/gokittest/inmem"
	"github.com/doit05/gokittest/inspection"
	"github.com/doit05/gokittest/location"
	"github.com/doit05/gokittest/routing"
	"github.com/doit05/gokittest/tracking"
)
...
func main() {
	...
	bs = booking.NewLoggingService(log.With(logger.Logger, "component", "booking"), bs)
	...
	ts = tracking.NewLoggingService(log.With(logger.Logger, "component", "tracking"), ts)
	...
	hs = handling.NewLoggingService(log.With(logger.Logger, "component", "handling"), hs)
	...
	httpLogger := log.With(logger.Logger, "component", "http")
	...
	go func() {
		logger.Logger.Log("transport", "http", "address", *httpAddr, "msg", "listening")
	...
	logger.Logger.Log("terminated", <-errs)
}
